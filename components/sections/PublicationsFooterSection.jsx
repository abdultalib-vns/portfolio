...
export default function PublicationsFooterSection() {
  ...
  useEffect(() => {
    ...
    function setImageLeft() {
      ...
      if (imageOverlayRef.current) gsap.set(imageOverlayRef.current, { opacity: 0.72 })
    }
    ...
    function onScroll() {
      ...
      if (isMobile) {
        ...
        if (vidUni?.uOpacity) vidUni.uOpacity.value = xfade

        if (videoEl && xfade > 0.04 && !videoPlaying) {
          videoPlaying = true
          videoEl.play().catch(() => {})
        } else if (videoEl && xfade <= 0.04 && videoPlaying) {
          videoPlaying = false
          videoEl.pause()
  ...
  return (
    <div ref={wrapperRef} className={styles.wrapper}>
      <div ref={stickyRef} className={styles.sticky}>
        <video ref={videoSrcRef} className={styles.videoSource} muted playsInline loop preload="auto" aria-hidden />
        <video className={styles.footerVideoFallback} src="/assets/footer-video.mp4" autoPlay muted loop playsInline preload="auto" aria-hidden />
        <canvas ref={canvasRef} className={styles.glCanvas} aria-hidden />
        <div className={styles.mobileFooterBg} aria-hidden>
          <Image src="/assets/mobile-footer.webp" alt="" fill sizes="100vw" className={styles.mobileFooterBgImg} />
        </div>
        <div className={styles.mobileDarkOverlay} aria-hidden />

        <div ref={imageWrapRef} className={styles.imageWrap}>
          <Image src="/assets/jyoti-footer.jpeg" alt="" fill quality={100} sizes="100vw" className={styles.imageEl} />
        ...
        <div ref={pubContentRef} className={styles.pubContent}>
          <div className={styles.pubHero}>
            ...
            <h2 ref={headingRef} className={styles.heading}>Products, awards, and proof of work</h2>
          </div>
            ...
            {PUBS.map((pub, i) => (
              ...
              >
                ...
                <div className={styles.itemRight}>
                  ...
                  <span className={styles.readBtn}>Open <FiArrowUpRight /></span>
                </div>
              </a>
            ))}
          </div>
        </div>
        {/* Professional interstitial (step 2) */}
        <div ref={interstitialRef} className={styles.interstitial} aria-hidden>
          <div className={styles.interstitialGrid}>
            <div className={styles.interstitialIntro}>
              <span className={styles.interLabel}>Availability</span>
              <h2 className={styles.interHeadline}>Ready for AI automation, QA architecture, and product builds.</h2>
              <p className={styles.interCopy}>
                Remote, WFO, or hybrid engagements from Varanasi, UP, India - focused on agentic testing systems, reliable automation, and measurable release impact.
              </p>
              <div className={styles.interMetaRow}>
                <span>{profile.location.availability}</span>
                <span>{profile.location.based}</span>
              </div>
            </div>

            <div className={styles.interstitialCenter}>
              <div className={styles.interCardPrimary}>
                <span className={styles.interCardEyebrow}>Current Focus</span>
                <strong>AI-powered quality engineering</strong>
                <p>Robot Framework, Selenium, Appium, Playwright, LangChain, LangGraph, RAG, MCP, and self-healing automation workflows.</p>
              </div>
              <div className={styles.interCardGrid}>
                <span>Web</span>
                <span>Mobile</span>
                <span>API</span>
                <span>CI/CD</span>
            ...
            <div className={styles.interstitialRight}>
              {profile.stats.map((stat, i) => (
                <div key={stat.label} className={styles.interNum}>
        ...
        <div ref={footerContentRef} className={styles.footerContent}>
          ...
          <div className={styles.mobileLayout}>
            ...
            <div className={styles.mobileCtas}>
              ...
              <a href="tel:+917518077446" className={styles.mobileTalkBtn}>
                Call me <FiArrowUpRight />
              </a>
            </div>
            ...
            <div ref={rightRef} className={styles.rightCol}>
              <div className={styles.ctaBlock}>
                ...
                <div className={styles.ctaActions}>
                  ...
                  <a href="tel:+917518077446" className={styles.callBtn}>
                    Call me
                  </a>
                </div>
              </div>
